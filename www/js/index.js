...
var App = function () {
    ...
    _createClass(App, [{
        ...
        value: function displayMessage(message) {
            var msgType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "warning";
        ...
        key: 'drawInputs',
        value: function drawInputs() {
            var count = (0, _jquery2.default)('#theinterval').val();
            ...
            for (var i = 0; i < count; i++) {
                ...
                (0, _jquery2.default)('#partitionscontainer').append(element);
            }
        }
    }, {
        key: 'undrawInputs',
        value: function undrawInputs() {
            (0, _jquery2.default)('#partitionscontainer').html("");
        }
        ...
        key: 'computeValues',
        value: function computeValues(partitions) {

            var IG = partitions[0].entropy;
            var countG = partitions[0].count;

            for (var i = 1; i < _lodash2.default.size(partitions); i++) {
                var partition = partitions[i];
                var countP = partition.count;
                var entropy = partition.entropy;
        ...
        value: function submit() {
            ...
            var baseArray = (0, _jquery2.default)('#baseclasses').val().toString().split(' ').filter(function (x) {
                return x != undefined && x != null && x != "";
            });
            var baseCount = _lodash2.default.size(baseArray);
            console.log(baseArray);

            var basePartition = new _partition.Partition(baseArray);
            ...
            var partitionsCount = (0, _jquery2.default)('#theinterval').val();
            ...
            for (var i = 0; i < partitionsCount; i++) {
                var element = (0, _jquery2.default)('#partition' + i);
                ...
                var values = element.val().split(' ').filter(function (x) {
                    return x != undefined && x != null && x != "";
                });
                var valCount = _lodash2.default.size(values);
                console.log(values);
                ...
                var tempPart = new _partition.Partition(values);
        ...
        key: 'handlePartitions',
        value: function handlePartitions() {
            var isit = (0, _jquery2.default)('#theindicator').is(":checked");
        ...
        value: function bootstrap() {
            ...
            (0, _jquery2.default)('#theindicator').click(this.handlePartitions.bind(this));
            (0, _jquery2.default)('#submitBtn').click(this.submit.bind(this));
        }
    }]);
...
},{"./partition":3,"jquery":4,"lodash":5}],2:[function(require,module,exports){
'use strict';
...
var Partition = function () {
    function Partition(array) {
        ...
        this.elementsCount = _lodash2.default.size(array);
        this.array = _lodash2.default.cloneDeep(array);
        this.entropy = 0;
        this.count = 0;
